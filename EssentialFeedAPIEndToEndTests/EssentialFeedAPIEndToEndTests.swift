...
//
//  Created by Omar Alali on 07/02/2023.
//
...
//            }
            // Another way to know exactly what item failed since we have only 8 items we can do this :
        ...
        default:
            XCTFail("Expected sucsseful feed result , got no result instead")
        }
    }
